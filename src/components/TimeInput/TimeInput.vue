...
export default {
  ...
  computed: {
    ...
    format() {
      return this.onlyDate ? "YYYY-MM-DD H:mm" : "YYYY-MM-DD H:mm"
    },
  },
};
</script>
...
.custom-button.is-hover,
.custom-button:hover {
  border: 1px solid transparent !important;
}
.custom-button.is-hover .custom-button-effect,
.custom-button:hover .custom-button-effect {
  -webkit-transform: scale(1);
  transform: scale(1);
  opacity: 0.6;
}
.custom-button.is-hover svg,
.custom-button:hover svg {
  fill: #fff !important;
}
.custom-button.is-hover .custom-button-content,
...
.field.is-dark.is-disabled .field-input,
.field.is-dark.is-disabled .field-label {
  color: #000;
}
.field-label {
  position: absolute;
...
.datepicker-container
  .datepicker-days
  .datepicker-day.disabled.selected {
  color: #fff;
}
.datepicker-container
  .datepicker-days
...
@media screen and (max-width: 415px) {
  ...
  .datepicker-container:not(.inline) .datepicker-controls {
...
.time-picker-column-item.disabled
  .time-picker-column-item-text:hover {
  color: #ccc !important;
}
.time-picker-column-item.disabled
  .time-picker-column-item-effect {
...
.datepicker-buttons-container
  .datepicker-button.now.right-margin {
  margin-right: 10px;
}
.datepicker-buttons-container
...
.datepicker-buttons-container.is-dark .datepicker-button,
.datepicker-buttons-container.is-dark {
  background-color: #424242;
}
.datepicker-buttons-container.is-dark
  .datepicker-button:not(.now),
.datepicker-buttons-container.is-dark:not(.now) {
  border-color: #757575;
}
.datepicker-buttons-container.is-dark .datepicker-button svg,
.datepicker-buttons-container.is-dark svg {
  fill: #fff !important;
}
.datetimepicker {
  position: absolute;
...
@media screen and (max-width: 415px) {
  ...
  .datepicker-container.has-shortcuts {
    -webkit-box-orient: vertical;
    -webkit-box-direction: normal;
    -ms-flex-direction: column;
    flex-direction: column;
...
<style>
.header-picker {
    background-color: #104550 !important;
}
.datepicker-day-effect {
    background-color: #104550 !important;
}
